...
john_groceries = Category.create(name: 'Groceries', icon: 'basket', user: john)
john_entertainment = Category.create(name: 'Entertainment', icon: 'controller', user: john)
...
caroline_groceries = Category.create(name: 'Groceries', icon: 'basket', user: caroline)
